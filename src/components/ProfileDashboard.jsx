      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 md:pt-0">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end">
          ...
          <div className="ml-0 sm:ml-auto mt-4 sm:mt-0 w-full sm:w-auto">
            <button className="bg-white text-gray-700 hover:bg-gray-50 font-semibold py-2 px-4 border border-gray-300 rounded-lg shadow-sm flex items-center justify-center text-sm w-full" onClick={()=>navigate("/Edit")}>
              <PencilIcon />
              Edit Profile
            </button>
          </div>
